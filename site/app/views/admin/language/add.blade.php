  ...
  <div class="col-md-12 ">
    ...
    <div class="portlet box blue">
      ...
      <div class="portlet-body form">
        {{Form::open(array("url"=>"/admin/language/store","method" => "POST","role"=>"form","class" => "form-horizontal","files"=>"true"))}}
          <div class="form-body">
            <div class="form-group">
              <label class="col-md-2 control-label">Language</label>
              <div class="col-md-9">
                {{Form::text('language','',array("class"=>"form-control", "placeholder"=>"language"))}}
