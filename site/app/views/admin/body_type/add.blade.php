  ...
  <div class="col-md-12 ">
    ...
    <div class="portlet box blue">
      ...
      <div class="portlet-body form">
        {{Form::open(array("url"=>"/admin/body_types/store","method" => "POST","role"=>"form","class" => "form-horizontal","files"=>"true"))}}
          <div class="form-body">
            <div class="form-group">
              <label class="col-md-2 control-label">Body Status</label>
              <div class="col-md-9">
                {{Form::text('body_type','',array("class"=>"form-control", "placeholder"=>"Body Status"))}}
